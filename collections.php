...
<head>
    ...
    <title>All Coin Collections | CoinX</title>
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>All Coin Collections</h1>
            <div class="breadcrumb">
                <a href="index.php">Home</a> / <span>Collections</span>
            </div>
        </div>
    </section>
                ...
                <?php 
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            if(isset($row['badge'])) {
                                echo '<div class="product-badge">' . $row['badge'] . '</div>';
                            }
                            ...
                            echo '<button class="action-btn"><i class="fas fa-heart"></i></button>';
                            echo '<button class="action-btn add-to-cart" data-id="' . (isset($row['id']) ? $row['id'] : '0') . '"><i class="fas fa-shopping-cart"></i></button>';
                            echo '</div>';
                            echo '</div>';
